...
public class SetupRockWallCommand extends SetupRaiseArmAndTraverseCommand {
    
    final String label = "RockWallBackwards Auto ";
    
    @Inject
    public SetupRockWallCommand(XPropertyManager propMan, RaiseArmAndTraverseDefenseCommandGroup auto,
